...
const DB_USER = 'Venkatraaman';
const DB_USER_PASSWORD = '1234567890';
// const DB_URL = `mongodb://${DB_USER}:${DB_USER_PASSWORD}@ds215380.mlab.com:15380/sandboxamigoscode`;
const DB_URL = `mongodb+srv://${DB_USER}:${DB_USER_PASSWORD}@cluster0.6jgm3.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`
// mongodb+srv://Venkatraaman:<password>@cluster0.6jgm3.mongodb.net/myFirstDatabase?retryWrites=true&w=majority
